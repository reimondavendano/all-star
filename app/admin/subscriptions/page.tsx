...
import {
    ...
    CreditCard, UserCheck, ExternalLink, ToggleLeft, ToggleRight
} from 'lucide-react';
                ...
                <table className="w-full">
                    <thead>
                        <tr className="border-b border-gray-900">
                            ...
                            <th className="text-left p-4 text-xs font-medium text-gray-500 uppercase">Business Unit</th>
                            <th className="text-left p-4 text-xs font-medium text-gray-500 uppercase">Status</th>
                            <th className="text-left p-4 text-xs font-medium text-gray-500 uppercase">Install Date</th>
                            ...
                            currentSubscriptions.map((subscription) => (
                                <React.Fragment key={subscription.id}>
                                    <tr className="border-b border-gray-900 hover:bg-[#1a1a1a] transition-colors cursor-pointer">
                                        ...
                                        <td className="p-4 text-white" onClick={() => toggleRow(subscription.id)}>{subscription.customer_name}</td>
                                        <td className="p-4 text-gray-400" onClick={() => toggleRow(subscription.id)}>{subscription.plan_name}</td>
                                        <td className="p-4 text-gray-400" onClick={() => toggleRow(subscription.id)}>{subscription.business_unit_name}</td>
                                        <td className="p-4" onClick={() => toggleRow(subscription.id)}>
                                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${subscription.active
                                        ...
                                        <td className="p-4 text-gray-400" onClick={() => toggleRow(subscription.id)}>{formatDate(subscription.date_installed)}</td>
                                        <td className="p-4">
